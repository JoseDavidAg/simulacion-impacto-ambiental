...
ChartPanel chartPanel2;
    ...
    public void graficarEspVida(JTable JTableCSV, JPanel jpane1) {
        ...
        XYSeries seriesNormal = new XYSeries("Esperanza de vida sin contaminacion");
        XYSeries seriesCalculada = new XYSeries("Esperanza de Vida con contaminacion");
    ...
    public void graficarTasasDeNatalidad(JTable JTableCSV, JPanel jpane1) {
        ...
        // Crear series para la gráfica
        XYSeries seriesTasaNatalidad = new XYSeries("Tasa de Natalidad sin contaminacion");
        XYSeries seriesTasaNatalidadCalculada = new XYSeries("Tasa de Natalidad con contaminacion");
        ...
        try {
            ...
            chartPanel2.setPreferredSize(new java.awt.Dimension(338, 340)); // Tamaño del panel
